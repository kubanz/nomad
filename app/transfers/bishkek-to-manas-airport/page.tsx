...
export const metadata: Metadata = {
  title: "Bishkek to Manas Airport Transfer | Private Car from $25",
  description: "Private transfer from Bishkek to Manas Airport (FRU). Hotel pickup, flight-time planning, terminal drop-off, sedan $25 and minivan $30.",
  alternates: { canonical: url, languages },
  openGraph: { title: "Bishkek to Manas Airport Private Transfer", description: "Hotel pickup and direct terminal drop-off from $25.", type: "website", url },
};
...
const jsonLd = {
  ...
  "@graph": [
    ...
    { "@type": "Service", name: "Bishkek to Manas Airport Private Transfer", url, provider: { "@type": "LocalBusiness", name: "Nomad Transfer", telephone: "+996552291808" }, offers: [{ "@type": "Offer", price: "25", priceCurrency: "USD", name: "Sedan" }, { "@type": "Offer", price: "30", priceCurrency: "USD", name: "Minivan" }] },
