...
export const metadata: Metadata = {
  ...
  description:
    "Частные трансферы из аэропорта Манас, Бишкека и Алматы в Каракол. Фиксированная цена за машину — седан от $135, минивэн от $155. Ответ в WhatsApp за 1–2 минуты.",
  keywords: [
