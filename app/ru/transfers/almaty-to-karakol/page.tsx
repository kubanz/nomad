    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Даты и часы работы КПП Кеген–Каркара могут меняться из-за официальных или сезонных ограничений. Перед выездом мы подтверждаем доступный переход и маршрут; при необходимости поездка проходит через Бишкек.",
          },
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Ориентировочно 7-8 часов на маршрут около 430 км, включая прохождение границы. Остановки, погода, трафик и очередь на КПП могут увеличить время.",
          },
        },
      ],
    },
