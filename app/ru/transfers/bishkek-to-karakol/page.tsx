...
export const metadata: Metadata = {
  title: "Трансфер Бишкек — Каракол | Башня Бурана и Боомское ущелье | От $136 | Nomad Transfer",
  description:
    "Частный трансфер из Бишкека в Каракол по северному берегу Иссык-Куля. Опционально: Башня Бурана (+$15), Боомское ущелье (+$10), Чолпон-Ата (+$20). Седан $136, Минивэн $167. Ответ в WhatsApp за 1–2 мин.",
  keywords: [
